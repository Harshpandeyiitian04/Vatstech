    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                >
                  <div className="p-6 pt-0 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {category.services.map((service, idx) => (
                      <div
                        key={idx}
                        className="border border-blue-100 rounded-lg p-4 hover:shadow-md hover:border-blue-300 transition-all cursor-pointer group"
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 mt-3 text-blue-600 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div
          id="why-choose"
          data-animate
          className={`mt-20 bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-10 text-white transition-all duration-1000 ${
            visibleSections['why-choose'] ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
          }`}
        >
          <h2 className="text-3xl font-bold text-center mb-10">Why Choose VatsTech?</h2>
      ...
      {selectedService && (
        <div
          className="fixed inset-0 bg-opacity-100 flex items-center justify-center p-4 z-50"
          onClick={() => setSelectedService(null)}
        >
          <div
            className="bg-white rounded-2xl p-8 max-w-lg w-full animate-fade-in"
            onClick={(e) => e.stopPropagation()}
          >
            <h3 className="text-2xl font-bold text-gray-800 mb-4">{selectedService.name}</h3>
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={() => setSelectedService(null)}
                className="flex-1 border border-gray-300 hover:border-gray-400 text-gray-700 py-3 rounded-lg font-semibold transition-colors"
              >
                Close
              </button>
            </div>
